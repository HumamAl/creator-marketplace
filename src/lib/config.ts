...
export const APP_CONFIG = {
  appName: "CreatorMarket",                  // Display name (sidebar header, page title)
  projectName: "Creator Marketplace",        // Client's product name (tab bar microtext, footer)
  ...
  aesthetic: "e-commerce" as AestheticProfile,  // Drives data-theme="..." on <html>
