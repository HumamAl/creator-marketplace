...
export const metadata = { title: "My Approach | Creator Marketplace Demo" };
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:px-6 space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            How I would tackle the key challenges in shipping your creator marketplace to the App Store
          </p>
        </div>

        {/* Executive summary dark hero */}
        <ExecutiveSummary
